...
export const homeCategories: HomeCategoryMock[] = [
  { id: 'literature', name: 'Văn học', icon: 'book', href: '/books?category=van-hoc' },
  { id: 'business', name: 'Kinh tế', icon: 'chart', href: '/books?category=kinh-te' },
  { id: 'life-skills', name: 'Kỹ năng sống', icon: 'sprout', href: '/books?category=ky-nang-song' },
  { id: 'children', name: 'Thiếu nhi', icon: 'teddy', href: '/books?category=thieu-nhi' },
  { id: 'psychology', name: 'Tâm lý', icon: 'brain', href: '/books?category=tam-ly' },
  { id: 'science', name: 'Khoa học', icon: 'atom', href: '/books?category=khoa-hoc' },
  { id: 'history', name: 'Lịch sử', icon: 'landmark', href: '/books?category=lich-su' },
  { id: 'all', name: 'Xem tất cả', icon: 'grid', href: '/books' },
]
...
export const newBooks: HomeBookMock[] = [
  ...
  },
  {
    ...
    href: '/books/hanh-trinh-ve-phuong-dong',
  },
  {
    ...
    discountPercent: 24,
    cover: muonKiepCover,
    href: '/books/muon-kiep-nhan-sinh',
  },
  {
    ...
    href: '/books/cay-cam-ngot-cua-toi',
  },
  {
    ...
    href: '/books/khi-hoi-tho-hoa-thinh-khong',
  },
]
