...
export type CartResponseDtoBlockingIssuesItem = typeof CartResponseDtoBlockingIssuesItem[keyof typeof CartResponseDtoBlockingIssuesItem];


export const CartResponseDtoBlockingIssuesItem = {
  AVAILABLE: 'AVAILABLE',
