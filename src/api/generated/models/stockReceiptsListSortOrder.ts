...
export type StockReceiptsListSortOrder = typeof StockReceiptsListSortOrder[keyof typeof StockReceiptsListSortOrder];


export const StockReceiptsListSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
