...
export type RevenueReportExportGroupBy = typeof RevenueReportExportGroupBy[keyof typeof RevenueReportExportGroupBy];


export const RevenueReportExportGroupBy = {
  DAY: 'DAY',
  WEEK: 'WEEK',
  MONTH: 'MONTH',
} as const;
