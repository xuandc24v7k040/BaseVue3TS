...
export type RevenueReportExportPaymentMethod = typeof RevenueReportExportPaymentMethod[keyof typeof RevenueReportExportPaymentMethod];


export const RevenueReportExportPaymentMethod = {
  ALL: 'ALL',
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
