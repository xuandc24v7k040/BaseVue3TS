...
export type ProductAttributesListSortOrder = typeof ProductAttributesListSortOrder[keyof typeof ProductAttributesListSortOrder];


export const ProductAttributesListSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
