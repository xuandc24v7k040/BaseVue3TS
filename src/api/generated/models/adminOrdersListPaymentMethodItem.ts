...
export type AdminOrdersListPaymentMethodItem = typeof AdminOrdersListPaymentMethodItem[keyof typeof AdminOrdersListPaymentMethodItem];


export const AdminOrdersListPaymentMethodItem = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
