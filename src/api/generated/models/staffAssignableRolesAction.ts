...
export type StaffAssignableRolesAction = typeof StaffAssignableRolesAction[keyof typeof StaffAssignableRolesAction];


export const StaffAssignableRolesAction = {
  CREATE: 'CREATE',
  ASSIGN: 'ASSIGN',
} as const;
