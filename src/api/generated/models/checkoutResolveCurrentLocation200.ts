 ...
 */
import type { CurrentLocationSuggestionDto } from './currentLocationSuggestionDto';

export type CheckoutResolveCurrentLocation200 = {
  statusCode: number;
  message: string;
  data: CurrentLocationSuggestionDto;
};
