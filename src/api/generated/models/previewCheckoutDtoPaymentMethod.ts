...
export type PreviewCheckoutDtoPaymentMethod = typeof PreviewCheckoutDtoPaymentMethod[keyof typeof PreviewCheckoutDtoPaymentMethod];


export const PreviewCheckoutDtoPaymentMethod = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
