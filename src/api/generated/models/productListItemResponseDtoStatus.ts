...
export type ProductListItemResponseDtoStatus = typeof ProductListItemResponseDtoStatus[keyof typeof ProductListItemResponseDtoStatus];


export const ProductListItemResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  INACTIVE: 'INACTIVE',
