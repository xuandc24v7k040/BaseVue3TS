 ...
 */
import type { PublicProductAvailabilityDto } from './publicProductAvailabilityDto';

export type StorefrontProductAvailability200 = {
  statusCode: number;
  message: string;
  data: PublicProductAvailabilityDto;
};
