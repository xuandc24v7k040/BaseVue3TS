 ...
 */
import type { ManagedUserPermissionResponseDtoEffect } from './managedUserPermissionResponseDtoEffect';
import type { PermissionResponseDto } from './permissionResponseDto';

export interface ManagedUserPermissionResponseDto {
  effect: ManagedUserPermissionResponseDtoEffect;
