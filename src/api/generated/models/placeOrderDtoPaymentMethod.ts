...
export type PlaceOrderDtoPaymentMethod = typeof PlaceOrderDtoPaymentMethod[keyof typeof PlaceOrderDtoPaymentMethod];


export const PlaceOrderDtoPaymentMethod = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
