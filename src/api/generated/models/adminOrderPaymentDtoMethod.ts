...
export type AdminOrderPaymentDtoMethod = typeof AdminOrderPaymentDtoMethod[keyof typeof AdminOrderPaymentDtoMethod];


export const AdminOrderPaymentDtoMethod = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
