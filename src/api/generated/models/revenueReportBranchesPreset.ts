...
export type RevenueReportBranchesPreset = typeof RevenueReportBranchesPreset[keyof typeof RevenueReportBranchesPreset];


export const RevenueReportBranchesPreset = {
  '7D': '7D',
  '30D': '30D',
  '90D': '90D',
} as const;
