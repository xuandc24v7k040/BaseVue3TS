...
export type InventoryMovementsListSortOrder = typeof InventoryMovementsListSortOrder[keyof typeof InventoryMovementsListSortOrder];


export const InventoryMovementsListSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
