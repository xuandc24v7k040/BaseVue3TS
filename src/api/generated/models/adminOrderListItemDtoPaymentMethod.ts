...
export type AdminOrderListItemDtoPaymentMethod = typeof AdminOrderListItemDtoPaymentMethod[keyof typeof AdminOrderListItemDtoPaymentMethod];


export const AdminOrderListItemDtoPaymentMethod = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
