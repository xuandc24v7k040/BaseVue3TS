...
export type RevenueReportExportSortOrder = typeof RevenueReportExportSortOrder[keyof typeof RevenueReportExportSortOrder];


export const RevenueReportExportSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
