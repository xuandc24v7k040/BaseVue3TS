...
export type UpdateProductAttributeDtoType = typeof UpdateProductAttributeDtoType[keyof typeof UpdateProductAttributeDtoType];


export const UpdateProductAttributeDtoType = {
  TEXT: 'TEXT',
  NUMBER: 'NUMBER',
  BOOLEAN: 'BOOLEAN',
  DATE: 'DATE',
