...
export type CustomerOrderReviewActionDtoType = typeof CustomerOrderReviewActionDtoType[keyof typeof CustomerOrderReviewActionDtoType];


export const CustomerOrderReviewActionDtoType = {
  WRITE: 'WRITE',
  VIEW: 'VIEW',
  NONE: 'NONE',
} as const;
