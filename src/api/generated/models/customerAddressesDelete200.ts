 ...
 */
import type { CustomerAddressDeleteResponseDto } from './customerAddressDeleteResponseDto';

export type CustomerAddressesDelete200 = {
  statusCode: number;
  message: string;
  data: CustomerAddressDeleteResponseDto;
};
