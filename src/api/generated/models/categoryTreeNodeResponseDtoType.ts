...
export type CategoryTreeNodeResponseDtoType = typeof CategoryTreeNodeResponseDtoType[keyof typeof CategoryTreeNodeResponseDtoType];


export const CategoryTreeNodeResponseDtoType = {
  NORMAL: 'NORMAL',
  SYSTEM: 'SYSTEM',
