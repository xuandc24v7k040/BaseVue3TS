...
export type RevenueReportTableSortOrder = typeof RevenueReportTableSortOrder[keyof typeof RevenueReportTableSortOrder];


export const RevenueReportTableSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
