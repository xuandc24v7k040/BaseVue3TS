...
export type StaffAssignmentRoleResponseDtoType = typeof StaffAssignmentRoleResponseDtoType[keyof typeof StaffAssignmentRoleResponseDtoType];


export const StaffAssignmentRoleResponseDtoType = {
  SYSTEM: 'SYSTEM',
  BRANCH: 'BRANCH',
  CUSTOMER: 'CUSTOMER',
} as const;
