...
export type RevenueReportBranchesSortOrder = typeof RevenueReportBranchesSortOrder[keyof typeof RevenueReportBranchesSortOrder];


export const RevenueReportBranchesSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
