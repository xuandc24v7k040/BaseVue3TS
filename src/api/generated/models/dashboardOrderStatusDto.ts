 ...
 */
import type { DashboardOrderStatusDtoStatus } from './dashboardOrderStatusDtoStatus';

export interface DashboardOrderStatusDto {
  status: DashboardOrderStatusDtoStatus;
  count: number;
}
