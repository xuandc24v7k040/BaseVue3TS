...
export type CustomerOrderResponseDtoStatus = typeof CustomerOrderResponseDtoStatus[keyof typeof CustomerOrderResponseDtoStatus];


export const CustomerOrderResponseDtoStatus = {
