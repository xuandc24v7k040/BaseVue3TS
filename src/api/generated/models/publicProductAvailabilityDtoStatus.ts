...
export type PublicProductAvailabilityDtoStatus = typeof PublicProductAvailabilityDtoStatus[keyof typeof PublicProductAvailabilityDtoStatus];


export const PublicProductAvailabilityDtoStatus = {
  IN_STOCK: 'IN_STOCK',
  LOW_STOCK: 'LOW_STOCK',
