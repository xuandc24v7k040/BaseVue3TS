 ...
 */
import type { PublicVariantAvailabilityDtoStatus } from './publicVariantAvailabilityDtoStatus';

export interface PublicVariantAvailabilityDto {
  /**
     * @minLength 26
     * @maxLength 26
  ...
  status: PublicVariantAvailabilityDtoStatus;
}
