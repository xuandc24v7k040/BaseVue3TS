 ...
 */
import type { CurrentLocationReverseResponseDto } from './currentLocationReverseResponseDto';

export type CheckoutReverseCurrentLocation200 = {
  statusCode: number;
  message: string;
  data: CurrentLocationReverseResponseDto;
};
