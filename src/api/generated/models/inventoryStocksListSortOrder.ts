...
export type InventoryStocksListSortOrder = typeof InventoryStocksListSortOrder[keyof typeof InventoryStocksListSortOrder];


export const InventoryStocksListSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
