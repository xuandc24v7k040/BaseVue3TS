...
export type AssignmentResponseDtoEffect = typeof AssignmentResponseDtoEffect[keyof typeof AssignmentResponseDtoEffect];


export const AssignmentResponseDtoEffect = {
  ALLOW: 'ALLOW',
  DENY: 'DENY',
} as const;
