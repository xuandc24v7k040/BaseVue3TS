...
export type AdminOrderPaymentDtoStatus = typeof AdminOrderPaymentDtoStatus[keyof typeof AdminOrderPaymentDtoStatus];


export const AdminOrderPaymentDtoStatus = {
  UNPAID: 'UNPAID',
  PENDING: 'PENDING',
  PAID: 'PAID',
  FAILED: 'FAILED',
