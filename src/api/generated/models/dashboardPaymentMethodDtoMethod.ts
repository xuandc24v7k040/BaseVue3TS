...
export type DashboardPaymentMethodDtoMethod = typeof DashboardPaymentMethodDtoMethod[keyof typeof DashboardPaymentMethodDtoMethod];


export const DashboardPaymentMethodDtoMethod = {
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
