 ...
 */
import type { StaffAssignmentRolePermissionResponseDto } from './staffAssignmentRolePermissionResponseDto';

export interface StaffAssignmentRolePermissionMappingResponseDto {
