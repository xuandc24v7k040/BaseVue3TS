...
export type DashboardOrderStatusDtoStatus = typeof DashboardOrderStatusDtoStatus[keyof typeof DashboardOrderStatusDtoStatus];


export const DashboardOrderStatusDtoStatus = {
