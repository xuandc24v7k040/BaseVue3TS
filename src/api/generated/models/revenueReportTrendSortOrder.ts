...
export type RevenueReportTrendSortOrder = typeof RevenueReportTrendSortOrder[keyof typeof RevenueReportTrendSortOrder];


export const RevenueReportTrendSortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
