 ...
 */
import type { CustomerOrderReviewActionDtoType } from './customerOrderReviewActionDtoType';

export interface CustomerOrderReviewActionDto {
  type: CustomerOrderReviewActionDtoType;
  /** @minimum 0 */
  count: number;
}
