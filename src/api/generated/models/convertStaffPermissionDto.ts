 ...
 */
import type { ConvertStaffPermissionDtoEffect } from './convertStaffPermissionDtoEffect';

export interface ConvertStaffPermissionDto {
  /**
     * @minLength 26
     * @maxLength 26
     ...
     */
  permissionId: string;
  effect: ConvertStaffPermissionDtoEffect;
}
