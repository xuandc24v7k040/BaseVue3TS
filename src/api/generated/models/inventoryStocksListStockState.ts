...
export type InventoryStocksListStockState = typeof InventoryStocksListStockState[keyof typeof InventoryStocksListStockState];


export const InventoryStocksListStockState = {
  IN_STOCK: 'IN_STOCK',
  LOW_STOCK: 'LOW_STOCK',
