...
export type CustomerOrdersListStatusItem = typeof CustomerOrdersListStatusItem[keyof typeof CustomerOrdersListStatusItem];


export const CustomerOrdersListStatusItem = {
