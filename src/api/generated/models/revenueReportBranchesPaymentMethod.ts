...
export type RevenueReportBranchesPaymentMethod = typeof RevenueReportBranchesPaymentMethod[keyof typeof RevenueReportBranchesPaymentMethod];


export const RevenueReportBranchesPaymentMethod = {
  ALL: 'ALL',
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
