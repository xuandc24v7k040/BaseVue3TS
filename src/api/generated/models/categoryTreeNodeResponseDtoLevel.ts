...
export type CategoryTreeNodeResponseDtoLevel = typeof CategoryTreeNodeResponseDtoLevel[keyof typeof CategoryTreeNodeResponseDtoLevel];


export const CategoryTreeNodeResponseDtoLevel = {
  NUMBER_1: 1,
  NUMBER_2: 2,
} as const;
