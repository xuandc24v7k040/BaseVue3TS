...
export type CreateProductAttributeDtoType = typeof CreateProductAttributeDtoType[keyof typeof CreateProductAttributeDtoType];


export const CreateProductAttributeDtoType = {
  TEXT: 'TEXT',
  NUMBER: 'NUMBER',
  BOOLEAN: 'BOOLEAN',
  DATE: 'DATE',
