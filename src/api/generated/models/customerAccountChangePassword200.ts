 ...
 */
import type { CustomerPasswordChangedResponseDto } from './customerPasswordChangedResponseDto';

export type CustomerAccountChangePassword200 = {
  statusCode: number;
  message: string;
  data: CustomerPasswordChangedResponseDto;
};
