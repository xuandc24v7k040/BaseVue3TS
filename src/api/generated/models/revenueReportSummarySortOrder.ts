...
export type RevenueReportSummarySortOrder = typeof RevenueReportSummarySortOrder[keyof typeof RevenueReportSummarySortOrder];


export const RevenueReportSummarySortOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;
