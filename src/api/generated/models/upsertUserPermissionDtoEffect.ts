...
export type UpsertUserPermissionDtoEffect = typeof UpsertUserPermissionDtoEffect[keyof typeof UpsertUserPermissionDtoEffect];


export const UpsertUserPermissionDtoEffect = {
  ALLOW: 'ALLOW',
  DENY: 'DENY',
} as const;
