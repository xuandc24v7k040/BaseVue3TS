 ...
 */
import type { PublicSearchSuggestionsResponseDto } from './publicSearchSuggestionsResponseDto';

export type StorefrontProductSearchSuggestions200 = {
  statusCode: number;
  message: string;
  data: PublicSearchSuggestionsResponseDto;
};
