...
export type RevenueReportTrendPaymentMethod = typeof RevenueReportTrendPaymentMethod[keyof typeof RevenueReportTrendPaymentMethod];


export const RevenueReportTrendPaymentMethod = {
  ALL: 'ALL',
  COD: 'COD',
  VNPAY: 'VNPAY',
} as const;
