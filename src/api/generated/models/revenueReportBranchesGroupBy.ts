...
export type RevenueReportBranchesGroupBy = typeof RevenueReportBranchesGroupBy[keyof typeof RevenueReportBranchesGroupBy];


export const RevenueReportBranchesGroupBy = {
  DAY: 'DAY',
  WEEK: 'WEEK',
  MONTH: 'MONTH',
} as const;
