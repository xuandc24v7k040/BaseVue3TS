 ...
 */
import type { PublicOptionDtoPresentationType } from './publicOptionDtoPresentationType';
import type { PublicOptionValueDto } from './publicOptionValueDto';
...
export interface PublicOptionDto {
  ...
  name: string;
  code: string;
  presentationType: PublicOptionDtoPresentationType;
  sortOrder: number;
